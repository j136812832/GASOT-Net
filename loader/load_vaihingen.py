...
class vaihingenloader(Dataset):
    ...
    '''
    def __init__(self, root, split='train', crop_size=256, scale=False, rotate=True, HorizontalFlip=True, normalize=False, degree=10):
        super().__init__()
        self.root = root
        self.split = split
...
if __name__ == '__main__':
    ...
    print(len(isprs))
    dataloader = DataLoader(isprs, batch_size=1, shuffle=True, num_workers=2, drop_last=True)
