...
def main(args, logger):
    ...
    model.load_state_dict({k.replace('module.', ''): v for k, v in
                           torch.load('/home/jim/nas/zhangyijie/igarss/loveda/segformer/6/resnet50bs4gpu7/model_BestmIOU.pth').items()})
...
if __name__ == '__main__':
    ...
    parser.add_argument('--root', default='/media/data/zyj/loveDA', help='data directory')
    ...
    parser.add_argument('--savedir', default="/home/jim/nas/zhangyijie/igarss/pic/loveda/segformer",
                        help="directory to save the model snapshot")
    parser.add_argument('--logFile', default="log.txt", help="storing the training and validation logs")
    parser.add_argument('--gpu', type=str, default="7", help="default GPU devices (0)")
